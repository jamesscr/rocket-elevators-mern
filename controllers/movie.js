import {sendError, formatActor, relatedMovieAggregation, getAverageRatings, topRatedMoviesPipeline} from '../utils/helper.js';
...
export const getSingleMovie = async (req, res) => {
	...
	const {_id: id, title, storyLine, cast, writers, director, releseDate, genres, tags, language, poster, trailer, type} = movie;
